...
def load_gtea_dataset():
    prediction_dir = '/nfs/hpc/dgx2-6/data/result1/Breakfast-Trained-S1-Tested-GTEA-S1/release'
    action_mapping = {}
    num_action_mapping = {}
...
def compute_ood_percentage(sorted_aggregated_probabilities):
    ...
    for threshold_name, threshold_value in thresholds.items():
        ...
        count_ood = sum(1 for file in top_files if file[0].startswith('S1')) # Change for ablation
...
if __name__ == '__main__':
    ...
    for dura_a in [True, False]:
        for dura_b in [True, False]:
            ...
            # action_occurrences_test_breakfast = load_salads_dataset() # Change for ablation
            action_occurrences_test_gtea = load_gtea_dataset()# Change for ablation
            action_occurrences_test.extend(action_occurrences_test_gtea)# Change for ablation
            ...
            with open('breakfast_{}_{}.txt'.format(dura_a, dura_b), 'w') as file:
