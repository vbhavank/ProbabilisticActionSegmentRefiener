...
class ASDiffusionModel(nn.Module):
    ...
    @torch.no_grad()
    def ddim_sample(self, video_feats, seed=None, mistaken_frames=None, most_uncertain_segment=None, random_mask=None, seq_segment_mask=None):
        ...
        if mistaken_frames is not None:
            # print(f"backbones: {backbone_feats.shape}\n\nmistakes: {mistaken_frames}")
        ...
        if seq_segment_mask is not None:
            backbone_feats[:,:,seq_segment_mask] = 0.0
